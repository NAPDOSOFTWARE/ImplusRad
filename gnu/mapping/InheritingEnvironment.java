    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localNamedLocation1 != null) {
          ...
          {
            localObject3 = localNamedLocation1;
            return localObject3;
          }
        }
        if (((0x20 & this.flags) != 0) && (paramBoolean))
        {
          ...
          localObject3 = addUnboundLocation(paramSymbol, paramObject, paramInt);
          if (((0x1 & this.flags) == 0) && (localNamedLocation2.isBound())) {
            redefineError(paramSymbol, paramObject, (Location)localObject3);
          }
          ((NamedLocation)localObject3).base = localNamedLocation2;
          if (localNamedLocation2.value != IndirectableLocation.INDIRECT_FLUIDS) {
            break label186;
          }
          ((NamedLocation)localObject3).value = localNamedLocation2.value;
          if (!(localObject3 instanceof SharedLocation)) {
            continue;
          }
          ((SharedLocation)localObject3).timestamp = this.baseTimestamp;
          continue;
        }
      ...
      {
        ((NamedLocation)localObject3).value = IndirectableLocation.DIRECT_ON_SET;
      }
      else
      {
        ((NamedLocation)localObject3).value = null;
        continue;
        label216:
        ...
        continue;
        label244:
        localObject3 = localNamedLocation2;
      }
    }
  }
