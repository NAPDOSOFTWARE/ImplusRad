  ...
  extends WrappedException
{
  ...
  public String getMessage()
  {
    ...
    if (this.number == -3)
    {
      ...
      localObject = this.expectedType;
      if ((localObject == null) && (this.number > 0) && ((this.proc instanceof MethodProc))) {
        localObject = ((MethodProc)this.proc).getParameterType(-1 + this.number);
      }
      if ((localObject != null) && (localObject != Type.pointer_type))
      {
        ...
        localObject = ((Type)localObject).getName();
      }
    }
    for (;;)
    {
