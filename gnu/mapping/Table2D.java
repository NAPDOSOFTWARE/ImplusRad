  ...
  protected Entry lookup(Object paramObject1, Object paramObject2, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (localObject2 != null)
    {
      ...
      for (;;)
      {
        ...
        break label102;
        label164:
        localObject1.chain = localEntry3;
        break label131;
        label174:
        if ((localObject5 == paramObject1) && (localObject6 == paramObject2)) {
          return localObject2;
        }
  ...
  void rehash()
  {
    ...
    if (m >= 0)
    {
      ...
      if (localObject1 != null)
      {
        ...
        localEntry = ((Entry)localObject1).chain;
        if (n == 0) {
          break label161;
        }
      ...
      for (;;)
      {
        ...
        break label123;
        label161:
        int i1 = k & (System.identityHashCode(localObject2) ^ System.identityHashCode(localObject3));
        ((Entry)localObject1).chain = arrayOfEntry2[i1];
