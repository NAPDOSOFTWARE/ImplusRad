  ...
  implements AttrContainer
{
  ...
  public void addHandler(Label paramLabel1, Label paramLabel2, ClassType paramClassType)
  {
    ...
    label104:
    for (ClassType localClassType = Type.javalangThrowableType;; localClassType = paramClassType)
    {
  ...
  public void disAssemble(ClassTypeWriter paramClassTypeWriter, int paramInt1, int paramInt2)
  {
      ...
      if (n < 120) {
        if (n < 87) {
          if (n < 3)
          {
            ...
            label151:
            paramClassTypeWriter.printConstantOperand(i5);
          }
        }
      }
    }
    for (;;)
    {
      ...
      if (n < 54)
      {
        ...
        i38 = n - 21;
        label445:
        paramClassTypeWriter.print("ilfdabcs".charAt(i38));
        if (i37 == -2) {
      ...
      if (n < 170)
      {
        ...
        if (n < 148)
        {
          paramClassTypeWriter.print("ilfdi".charAt((-133 + n) / 3));
          paramClassTypeWriter.print('2');
          paramClassTypeWriter.print("lfdifdildilfbcs".charAt(-133 + n));
          i3 = k;
          i1 = 0;
          break label117;
        }
        if (n < 153)
        {
          print("lcmp;fcmpl;fcmpg;dcmpl;dcmpg;", -148 + n, paramClassTypeWriter);
          i3 = k;
          i1 = 0;
          break label117;
        }
        if (n < 169)
        {
          if (n < 159)
          {
            ...
            print("eq;ne;lt;ge;gt;le;", -153 + n, paramClassTypeWriter);
          }
          for (;;)
          {
            ...
            if (n < 167)
            {
              ...
              for (;;)
              {
                print("eq;ne;lt;ge;gt;le;", -159 + n, paramClassTypeWriter);
                break;
                paramClassTypeWriter.print("if_acmp");
                n -= 6;
              }
            }
            print("goto;jsr;", -167 + n, paramClassTypeWriter);
          }
        }
      ...
      {
        if (n < 177) {
          paramClassTypeWriter.print("ilfda".charAt(-172 + n));
        }
      ...
      if (n < 182)
      {
        print("getstatic;putstatic;getfield;putfield;", -178 + n, paramClassTypeWriter);
        i1 = 2;
        i3 = k;
        break label117;
      }
      if (n < 185)
      {
        ...
        print("virtual;special;static;", -182 + n, paramClassTypeWriter);
        i1 = 2;
        i3 = k;
        break label117;
      }
      ...
      if (n < 196)
      {
        print("186;new;newarray;anewarray;arraylength;athrow;checkcast;instanceof;monitorenter;monitorexit;", -186 + n, paramClassTypeWriter);
      ...
      if (n < 200)
      {
        print("ifnull;ifnonnull;", -198 + n, paramClassTypeWriter);
      ...
      if (n < 202)
      {
        print("goto_w;jsr_w;", -200 + n, paramClassTypeWriter);
        int i6 = readInt(k);
        int i7 = k + 4;
        paramClassTypeWriter.print(' ');
  ...
  public final void emitFi()
  {
    ...
    for (;;)
    {
      ...
      if (k != j)
      {
        ...
        label272:
        boolean bool1 = this.unreachable_here;
        i = 0;
        if (bool1) {
          i = 1;
        }
  ...
  public void emitInvokeMethod(Method paramMethod, int paramInt)
  {
    ...
    if (paramInt == 185)
    {
      j = 5;
      reserve(j);
      k = paramMethod.arg_types.length;
      if (paramInt != 184) {
        break label111;
      }
      m = i;
  ...
  public void processFixups()
  {
    ...
    for (;;)
    {
      Label localLabel5;
      int i52;
      if (i6 < this.fixup_count)
      {
        int i50 = this.fixup_offsets[i6];
        int i51 = i50 & 0xF;
        ...
        while ((localLabel5 != null) && (i51 >= 4) && (i51 <= 7) && (1 + localLabel5.first_fixup < this.fixup_count) && (this.fixup_offsets[(1 + localLabel5.first_fixup)] == (0x4 | 0xF & this.fixup_offsets[localLabel5.first_fixup])))
        {
        ...
        case 11: 
          i6 += 2;
          this.fixup_labels[i6].position = (i52 + i5);
        case 0: 
        case 3: 
        case 14: 
        case 8: 
        ...
        case 6: 
          for (;;)
          {
            ...
            i4 -= 3;
            continue;
            localLabel5.position = (i52 + i5);
            continue;
            int i57 = 0x3 & 3 - (i52 + i5);
            i5 += i57;
            i4 += i57;
            continue;
            int i54 = localLabel5.position - (i52 + i5);
            if ((short)i54 != i54) {
              break label745;
            }
            this.fixup_offsets[i6] = (0x7 | i52 << 4);
          }
          int i55;
          if (i51 == 6)
          {
      ...
      i10 = 0;
      int i48;
      for (i11 = 0; i10 < i9; i11 = i48)
      {
        i48 = i11 + 1;
        byte[] arrayOfByte4 = this.code;
        int i49 = i10 + 1;
        arrayOfByte1[i11] = arrayOfByte4[i10];
        i10 = i49;
      }
      label873:
      i6 = localLabel5.first_fixup;
      int i53 = fixupOffset(i6);
      i5 = i52 + i5 - i53;
    }
    int i12 = 0xF & this.fixup_offsets[i8];
    Label localLabel3 = this.fixup_labels[i8];
    if ((localLabel2 != null) && (localLabel2.position < i11))
    {
    ...
    for (;;)
    {
      ...
      if ((this.stackMap != null) && (localLabel3 != null) && (localLabel3.stackTypes != null) && (localLabel3.needsStackMapEntry))
      {
        ...
        i16 = i11;
        continue;
        int i45 = localLabel3.position - i11;
        int i46 = i11 + 1;
        arrayOfByte1[i11] = this.code[i10];
        int i47 = i46 + 1;
        arrayOfByte1[i46] = ((byte)(i45 >> 8));
        i16 = i47 + 1;
        arrayOfByte1[i47] = ((byte)(i45 & 0xFF));
        i15 = i10 + 3;
        continue;
        int i34 = localLabel3.position - i11;
        byte b = this.code[i10];
        int i36;
        int i35;
        if (i12 == 6)
        {
          int i42 = invert_opcode(b);
          int i43 = i11 + 1;
          arrayOfByte1[i11] = i42;
          int i44 = i43 + 1;
          arrayOfByte1[i43] = 0;
          i36 = i44 + 1;
          arrayOfByte1[i44] = 8;
        ...
        {
          int i37 = i36 + 1;
          arrayOfByte1[i36] = i35;
          int i38 = i37 + 1;
          arrayOfByte1[i37] = ((byte)(i34 >> 24));
          int i39 = i38 + 1;
          arrayOfByte1[i38] = ((byte)(i34 >> 16));
          int i40 = i39 + 1;
          arrayOfByte1[i39] = ((byte)(i34 >> 8));
          int i41 = i40 + 1;
          arrayOfByte1[i40] = ((byte)(i34 & 0xFF));
          i15 = i10 + 3;
          i16 = i41;
          break;
          i35 = (byte)(b + 33);
        ...
        byte[] arrayOfByte2 = this.code;
        i15 = i10 + 1;
        arrayOfByte1[i11] = arrayOfByte2[i10];
        int i33;
        for (int i21 = i20;; i21 = i33)
        {
          i18--;
          if (i18 < 0) {
            break;
        ...
        label1484:
        int i28 = this.fixup_labels[i8].position - i19;
        int i25;
        int i29 = i25 + 1;
        arrayOfByte1[i25] = ((byte)(i28 >> 24));
        int i30 = i29 + 1;
        arrayOfByte1[i29] = ((byte)(i28 >> 16));
        int i31 = i30 + 1;
        arrayOfByte1[i30] = ((byte)(i28 >> 8));
        int i32 = i31 + 1;
        arrayOfByte1[i31] = ((byte)(i28 & 0xFF));
        int i24;
        i15 = i24 + 4;
        for (i16 = i32;; i16 = i21)
        {
          int i22 = this.fixup_count;
          if ((i8 >= i22) || (fixupKind(i8 + 1) != 3)) {
            break label1071;
          }
          i8++;
          int i23 = fixupOffset(i8);
          i24 = i15;
          int i26;
          for (i25 = i16; i24 < i23; i25 = i26)
          {
            i26 = i25 + 1;
            byte[] arrayOfByte3 = this.code;
            int i27 = i24 + 1;
            arrayOfByte1[i25] = arrayOfByte3[i24];
            i24 = i27;
          }
          break label1484;
          Label localLabel4 = this.fixup_labels[(i8 + 2)];
          int i17 = fixupOffset(i8 + 1);
          if (this.stackMap != null) {
            localLabel2 = mergeLabels(localLabel2, localLabel4);
          }
          addHandler(this.fixup_labels[i8].position, this.fixup_labels[(i8 + 1)].position, i11, i17);
          i8 += 2;
          i15 = i10;
          i16 = i11;
          break label1071;
          ...
          i8++;
          int i14 = fixupOffset(i8);
          if (i14 != i7) {
            this.lines.put(i14, i11);
          }
          i7 = i14;
          i15 = i10;
          i16 = i11;
          ...
          {
            if (i4 != i11) {
              throw new Error("PC confusion new_pc:" + i11 + " new_size:" + i4);
            }
          }
          else
          {
            i8 = localLabel3.first_fixup;
            i13 = fixupOffset(i8);
            i9 = i13;
            if (localLabel3.position == i11) {
              break label1937;
            }
  ...
  {
    return this.stack_types[(-1 + this.SP)];
  }
