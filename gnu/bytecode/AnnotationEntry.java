  ...
  implements Annotation
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    AnnotationEntry localAnnotationEntry;
    do
    {
      return false;
      localAnnotationEntry = (AnnotationEntry)paramObject;
    } while (!getAnnotationType().getName().equals(localAnnotationEntry.getAnnotationType().getName()));
