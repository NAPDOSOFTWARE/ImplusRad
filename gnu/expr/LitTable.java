  ...
  implements ObjectOutput
{
  ...
  void emit(Literal paramLiteral, boolean paramBoolean)
  {
    ...
    if ((paramLiteral.value instanceof Object[]))
    {
      ...
      for (;;)
      {
        ...
        break;
        label157:
        localCodeAttr.emitDup(localType);
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      ...
      break label446;
      label719:
      int k = paramLiteral.argTypes.length;
      j = 0;
      if (k <= 0) {
        break label539;
      }
  ...
  {
    Literal localLiteral1;
    if (paramObject == null) {
      localLiteral1 = Literal.nullLiteral;
    }
    do
    {
      return localLiteral1;
      localLiteral1 = (Literal)this.literalTable.get(paramObject);
    } while (localLiteral1 != null);
    ...
    for (;;)
    {
      ...
      synchronized (staticTable)
      {
        ...
        if (staticTable.get(localClass2, Boolean.TRUE, null) != null) {
          break label313;
        }
        staticTable.put(localClass2, Boolean.TRUE, localClass2);
        localObject3 = localClassType.getFields();
        if (localObject3 != null)
        {
          ...
          try
          {
            localObject4 = ((gnu.bytecode.Field)localObject3).getReflectField().get(null);
          ...
          catch (Throwable localThrowable)
          {
            ...
            Literal localLiteral2;
            error("caught " + localThrowable + " getting static field " + localObject3);
            continue;
          }
          localField = ((gnu.bytecode.Field)localObject3).getNext();
          localObject3 = localField;
          continue;
          localLiteral2 = new Literal(localObject4, (gnu.bytecode.Field)localObject3, this);
          staticTable.put(localObject4, null, localLiteral2);
          if (paramObject != localObject4) {
            continue;
          }
          localObject2 = localLiteral2;
        }
      }
      ...
      ClassType localClassType = (ClassType)Type.make(localClass2);
    }
  ...
  Method getMethod(ClassType paramClassType, String paramString, Literal paramLiteral, boolean paramBoolean)
  {
    ...
    Object[] arrayOfObject1 = new Object[localObject1.length];
    Type[] arrayOfType2 = new Type[localObject1.length];
    int k = 0;
    int m = 0;
    if (k == i)
    {
    ...
    throws IOException
  {
    ...
    for (;;)
    {
      ...
      break label113;
      label508:
      localLiteral.argValues = new Object[j];
