  ...
  extends AccessExp
{
  ...
  public static int canUseInc(Expression paramExpression, Declaration paramDeclaration)
  {
    ...
    if ((paramDeclaration.isSimple()) && (localVariable.getType().getImplementationType().promote() == Type.intType) && ((paramExpression instanceof ApplyExp)))
    {
      ...
      if (localApplyExp.getArgCount() == 2)
      {
        ...
        i = 1;
        Object localObject2 = localApplyExp.getArg(0);
        localObject3 = localApplyExp.getArg(1);
        if (((localObject2 instanceof QuoteExp)) && (i > 0))
        {
        ...
        {
          ReferenceExp localReferenceExp = (ReferenceExp)localObject2;
    ...
    for (;;)
    {
      ...
      if (localObject1 == AddOp.$Mn)
      {
        ...
        break;
        label156:
        Object localObject4 = ((Expression)localObject3).valueIfConstant();
        ...
        else if ((localObject4 instanceof IntNum))
        {
    ...
    throws Throwable
  {
    ...
    for (;;)
    {
      ...
      break;
      label127:
      Object localObject2 = this.new_value.eval(localEnvironment);
  ...
  public void compile(Compilation paramCompilation, Target paramTarget)
  {
    ...
    for (;;)
    {
      ...
      break;
      label155:
      if (((((Declaration)localObject1).shouldEarlyInit()) || (((Declaration)localObject1).isAlias())) && ((((Declaration)localObject1).context instanceof ModuleExp)) && (isDefining()) && (!((Declaration)localObject1).ignorable()))
      {
        if (((Declaration)localObject1).shouldEarlyInit()) {
          BindingInitializer.create((Declaration)localObject1, this.new_value, paramCompilation);
        }
        j = 0;
        if (i != 0)
        {
          ((Declaration)localObject1).load(this, 0, paramCompilation, Target.pushObject);
          j = 1;
        }
      }
      else
      {
        ...
        label359:
        if ((((Declaration)localObject1).isAlias()) && (isDefining()))
        {
          ((Declaration)localObject1).load(this, 2, paramCompilation, Target.pushObject);
        ...
        {
          ((Declaration)localObject1).load((AccessExp)localObject2, 2, paramCompilation, Target.pushObject);
