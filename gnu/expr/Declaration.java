  ...
  implements SourceLocator
{
  ...
  public final Variable allocateVariable(CodeAttr paramCodeAttr)
  {
    ...
    label75:
    for (Variable localVariable = null;; localVariable = localDeclaration.var)
    {
  ...
  public boolean ignorable()
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localExpression = getValue();
      } while ((localExpression == null) || (!(localExpression instanceof LambdaExp)));
      localLambdaExp = (LambdaExp)localExpression;
    } while ((localLambdaExp.isHandlingTailCalls()) && (!localLambdaExp.getInlineOnly()));
    return true;
  }
  ...
  public boolean isStatic()
  {
    ...
    do
    {
      ...
      {
        return bool;
      } while ((getFlag(2048L)) || (isCompiletimeConstant()));
      if (getFlag(4096L)) {
        return false;
      }
      localLambdaExp = this.context.currentLambda();
    } while (((localLambdaExp instanceof ModuleExp)) && (((ModuleExp)localLambdaExp).isStatic()));
    return false;
  }
  ...
  public void makeField(ClassType paramClassType, Compilation paramCompilation, Expression paramExpression)
  {
    ...
    if (!ignorable())
    {
      ...
      for (int j = -2 + str2.length();; j = str2.length())
      {
        int k = 0;
