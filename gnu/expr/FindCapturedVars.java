  ...
  extends ExpExpVisitor<Void>
{
  ...
  static Expression checkInlineable(LambdaExp paramLambdaExp, Set<LambdaExp> paramSet)
  {
    ...
    if (paramLambdaExp.tailCallers != null)
    {
      ...
      {
        LambdaExp localLambdaExp = (LambdaExp)localIterator.next();
        Expression localExpression = checkInlineable(localLambdaExp, paramSet);
        if (localExpression == LambdaExp.unknownContinuation)
        {
          if ((localObject == null) || (localObject == localLambdaExp.body))
          {
            localObject = localLambdaExp.body;
        ...
        else if (localObject == null)
        {
          ...
          if (paramLambdaExp.inlineHome == null)
          {
            ...
            for (;;)
            {
              paramLambdaExp.inlineHome = localLambdaExp;
              break;
              localLambdaExp = localLambdaExp.inlineHome;
            }
          }
        }
  ...
  Declaration allocUnboundDecl(Object paramObject, boolean paramBoolean)
  {
    ...
    label164:
    for (Declaration localDeclaration = null;; localDeclaration = (Declaration)this.unknownDecls.get(localObject))
    {
