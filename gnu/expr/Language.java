...
public abstract class Language
{
  ...
  public static void registerLanguage(String[] paramArrayOfString)
  {
    ...
    arrayOfString;[(-1 + arrayOfString;.length)] = paramArrayOfString;
  ...
  public static Type string2Type(String paramString)
  {
    ...
    {
      Type localType = string2Type(paramString.substring(0, -2 + paramString.length()));
      if (localType == null) {
        return null;
      }
    ...
    do
    {
      do
      {
        do
        {
          ...
          i = paramType1.getSignature().charAt(0);
          j = paramType2.getSignature().charAt(0);
        } while (i == j);
  ...
  public Declaration declFromField(ModuleExp paramModuleExp, Object paramObject, gnu.bytecode.Field paramField)
  {
    ...
    if ((0x10 & paramField.getModifiers()) != 0)
    {
      ...
      if ((localObject1 instanceof String))
      {
        ...
        localObject1 = SimpleSymbol.valueOf(str3);
      }
      if (!bool1) {
        break label331;
      }
      localObject2 = Type.objectType;
      localDeclaration = paramModuleExp.addDeclaration(localObject1, (Type)localObject2);
    ...
    for (;;)
    {
      ...
      break label57;
      label319:
      localObject1 = Symbol.make(str2, str3);
      break label90;
      label331:
      localObject2 = getTypeFor(localType.getReflectClass());
      break label100;
      label345:
      k = 0;
      break label123;
  ...
  public final Type getLangTypeFor(Type paramType)
  {
    if (paramType.isExisting())
    {
      ...
      if (localClass != null) {
        paramType = getTypeFor(localClass);
      }
    }
    return paramType;
  }
  ...
  public Type getTypeFor(Expression paramExpression, boolean paramBoolean)
  {
    ...
    {
      localObject3 = ((QuoteExp)paramExpression).getValue();
      if ((localObject3 instanceof Type)) {
        localType = (Type)localObject3;
      }
    }
    label285:
    boolean bool1;
    ...
    do
    {
        ...
        do
        {
          do
          {
            ...
            do
            {
              ...
              localDeclaration = Declaration.followAliases(localReferenceExp.getBinding());
              str = localReferenceExp.getName();
              ...
              bool2 = localLocation instanceof Named;
              localType = null;
            } while (!bool2);
      ...
      bool1 = paramExpression instanceof ModuleExp;
      localType = null;
    } while (!bool1);
    ...
    throws ClassNotFoundException
  {
    ...
    //   0	72	0	this	Language
    //   0	72	1	paramString	String
    //   37	2	2	localClassNotFoundException	ClassNotFoundException
    //   4	2	3	localClass	Class
    //   40	27	4	localException	Exception
    //   9	20	5	localObject	Object
    // Exception table:
    //   from	to	target	type
    ...
    throws IOException, SyntaxException
  {
    ...
    label150:
    label156:
    while (localCompilation.getState() != 1)
    {
