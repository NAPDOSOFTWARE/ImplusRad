...
public class Parser
{
  ...
  public Expression parseAssignmentExpression()
    throws IOException, SyntaxException
  {
    Object localObject1 = parseConditionalExpression();
    ...
    if (localObject2 == Lexer.equalToken)
    {
      ...
      {
        SetExp localSetExp = new SetExp(((ReferenceExp)localObject1).getName(), localExpression);
    ...
    do
    {
      ...
      localReserved = (Reserved)localObject2;
    } while (!localReserved.isAssignmentOp());
    skipToken();
    Expression[] arrayOfExpression = { localObject1, parseAssignmentExpression() };
