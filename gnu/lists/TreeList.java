  ...
  implements Appendable, XConsumer, PositionConsumer, Consumable
{
  ...
  public int consumeIRange(int paramInt1, int paramInt2, Consumer paramConsumer)
  {
    ...
    for (;;)
    {
      ...
      for (i = k;; i = i15 - 1)
      {
        paramConsumer.write(this.data, i13, i - i13);
        break;
        j = paramInt2;
        break;
        char[] arrayOfChar2 = this.data;
        i15 = k + 1;
        if (arrayOfChar2[k] <= 40959) {
          break label1178;
        }
      }
      label162:
      ...
      {
        int i12 = m - 40960;
        paramConsumer.startElement(this.objects[i12]);
        i = k + 2;
        break;
      }
      if ((m >= 45056) && (m <= 57343))
      ...
      case 61719: 
        ...
        if ((paramConsumer instanceof XConsumer)) {
          ((XConsumer)paramConsumer).writeComment(this.data, i11, i10);
        }
        i = i11 + i10;
        break;
      case 61717: 
        ...
        int i9 = k + 2;
        if ((paramConsumer instanceof XConsumer)) {
          ((XConsumer)paramConsumer).writeCDATA(this.data, i9, i8);
        }
        for (;;)
        {
          i = i9 + i8;
          break;
          paramConsumer.write(this.data, i9, i8);
        }
      case 61716: 
        ...
        int i7 = k + 4;
        if ((paramConsumer instanceof XConsumer)) {
          ((XConsumer)paramConsumer).writeProcessingInstruction(str, this.data, i7, i6);
        }
        i = i7 + i6;
        break;
      case 61696: 
      ...
      case 61718: 
        ...
        break;
      case 61702: 
        paramConsumer.write(this.data, k, m + 1 - 61702);
        i = k + 1;
        break;
      case 61711: 
  ...
  public Object documentUriOfPos(int paramInt)
  {
    ...
    do
    {
      ...
      {
        return null;
      } while (this.data[i] != 61712);
      j = i + 5;
      if (j == this.gapStart) {
        j = this.gapEnd;
      }
    } while ((j >= this.data.length) || (this.data[j] != 61720));
  ...
  public boolean hasNext(int paramInt)
  {
    ...
    do
    {
      return false;
      j = this.data[i];
    } while ((j == 61706) || (j == 61707) || (j == 61708) || (j == 61713));
    return true;
  }
  ...
  public int nextMatching(int paramInt1, ItemPredicate paramItemPredicate, int paramInt2, boolean paramBoolean)
  {
    ...
    label778:
    throw new Error("unknown code:" + i2);
  }
  ...
  public void startElement(int paramInt)
  {
    ...
    setIntN(3 + this.gapEnd, -3 + this.gapStart);
    setIntN(5 + this.gapEnd, this.currentParent);
    this.currentParent = (-3 + this.gapStart);
  }
      ...
      else
      {
        ...
        case 61719: 
          ...
          if ((!paramBoolean) || (j == 61717)) {
            paramStringBuffer.append(this.data, i4, i3);
          }
          return i4 + i3;
        case 61696: 
        case 61697: 
        ...
        case 61704: 
          ...
          int i1 = getIntN(k);
          if (i1 < 0) {}
          for (int i2 = this.data.length;; i2 = k - 1)
          {
            k = 7 + (i1 + i2);
            localObject = null;
            break;
  ...
  public void toString(String paramString, StringBuffer paramStringBuffer)
  {
    ...
    for (;;)
    {
      ...
      for (i = n;; i = i19 - 1)
      {
        ...
        paramStringBuffer.append(this.data, i17, i - i17);
        k = 0;
        break;
        char[] arrayOfChar3 = this.data;
        i19 = n + 1;
        if (arrayOfChar3[n] <= 40959) {
          break label1497;
        }
      }
      ...
      if ((i1 >= 40960) && (i1 <= 45055))
      {
        ...
        paramStringBuffer.append('<');
        paramStringBuffer.append(this.objects[i16].toString());
        i = n + 2;
        m = 1;
        k = 0;
        break;
      ...
      case 61719: 
        ...
        int i15 = n + 2;
        paramStringBuffer.append("<!--");
        paramStringBuffer.append(this.data, i15, i14);
        paramStringBuffer.append("-->");
        i = i15 + i14;
        break;
      case 61717: 
        ...
        paramStringBuffer.append(this.data, i13, i12);
        paramStringBuffer.append("]]>");
        i = i13 + i12;
        break;
      case 61716: 
        ...
        int i9 = getIntN(n);
        int i10 = n + 2;
        paramStringBuffer.append(this.objects[i9]);
        int i11 = getIntN(i10);
        i = i10 + 2;
        if (i11 > 0)
        {
          paramStringBuffer.append(' ');
          paramStringBuffer.append(this.data, i, i11);
          i += i11;
        }
        paramStringBuffer.append("?>");
        break;
      ...
      case 61702: 
        ...
        paramStringBuffer.append(this.data, n, i1 + 1 - 61702);
        i = n + 1;
        k = 0;
        break;
      case 61711: 
      ...
      case 61701: 
        ...
        {
          label1153:
          paramStringBuffer.append(Double.longBitsToDouble(getLongN(n)));
          i = n + 4;
          break;
          k = 1;
        }
