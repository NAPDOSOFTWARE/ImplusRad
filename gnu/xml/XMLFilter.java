  ...
  implements DocumentHandler, ContentHandler, SourceLocator, XConsumer, PositionConsumer
{
  ...
  int mappingTableMask = -1 + this.mappingTable.length;
  ...
  void closeStartTag()
  {
    ...
    String str5;
    String str6;
    for (NamespaceBinding localNamespaceBinding1 = NamespaceBinding.predefinedXML;; localNamespaceBinding1 = (NamespaceBinding)this.workStack[(-2 + this.nesting)])
    {
      ...
      for (i = 0;; i++)
      {
        ...
        Object localObject6 = this.workStack[(-1 + (i + this.nesting))];
        if ((localObject6 instanceof Symbol))
        {
          localSymbol4 = (Symbol)localObject6;
          str5 = localSymbol4.getPrefix();
          if (str5 == "") {
            str5 = null;
          }
          str6 = localSymbol4.getNamespaceURI();
          if (str6 == "") {
            str6 = null;
          }
          if ((i <= 0) || (str5 != null) || (str6 != null)) {
            break;
          }
        }
      }
    ...
    for (NamespaceBinding localNamespaceBinding3 = localNamespaceBinding2;; localNamespaceBinding3 = localNamespaceBinding3.next)
    {
      ...
      if (localNamespaceBinding3 == null)
      {
        ...
        localNamespaceBinding2 = findNamespaceBinding(str5, str6, localNamespaceBinding2);
        break;
      }
      if (localNamespaceBinding3.prefix == str5)
      {
        if (localNamespaceBinding3.uri == str6) {
          break;
        }
        if (i6 != 0)
        {
        ...
        label257:
        label377:
        for (NamespaceBinding localNamespaceBinding4 = localNamespaceBinding2;; localNamespaceBinding4 = localNamespaceBinding4.next)
        {
          int i7;
          String str7;
          if (localNamespaceBinding4 == null)
          {
            i7 = 1;
            str7 = ("_ns_" + i7).intern();
            if (localNamespaceBinding2.resolve(str7) != null) {}
          }
          do
          {
            localNamespaceBinding2 = findNamespaceBinding(str7, str6, localNamespaceBinding2);
            String str8 = localSymbol4.getLocalName();
            if (str6 == null) {
              str6 = "";
            }
            this.workStack[(-1 + (i + this.nesting))] = Symbol.make(str6, str8, str7);
            break;
            i7++;
            break label257;
            if (localNamespaceBinding4.uri != str6) {
              break label377;
            }
            str7 = localNamespaceBinding4.prefix;
          } while (localNamespaceBinding2.resolve(str7) == str6);
        }
      }
    }
    label397:
    ...
    if (j <= this.attrCount)
    {
      Object localObject1 = this.workStack[(-1 + (j + this.nesting))];
      ...
      if (((localObject1 instanceof MappingInfo)) || (this.out == this.tlist)) {
        if ((localObject1 instanceof MappingInfo))
        {
          ...
          if ((j > 0) && (((str1 == null) && (str2 == "xmlns")) || (str1 == "xmlns")))
          {
            m = 1;
            str3 = "(namespace-node)";
            n = localMappingInfo1.tagHash;
            int i1 = n & this.mappingTableMask;
            localMappingInfo2 = this.mappingTable[i1];
            if (localMappingInfo2 != null) {
              break label845;
            }
            localMappingInfo2 = new MappingInfo();
            localMappingInfo2.tagHash = n;
            localMappingInfo2.prefix = str1;
            localMappingInfo2.local = str2;
            localMappingInfo2.nextInBucket = this.mappingTable[i1];
            this.mappingTable[i1] = localMappingInfo2;
            localMappingInfo2.uri = str3;
            localMappingInfo2.qname = Symbol.make(str3, str2, str1);
            if (j == 0)
            {
            ...
            this.workStack[(-1 + (j + this.nesting))] = localMappingInfo2;
            i2 = 1;
            if (i2 >= j) {
              break label1074;
            }
            localObject4 = this.workStack[(-1 + (i2 + this.nesting))];
      ...
      label1053:
      for (Symbol localSymbol2 = (Symbol)localObject4;; localSymbol2 = ((MappingInfo)localObject4).qname)
      {
        if (str2 == localSymbol2.getLocalPart())
        {
          String str4 = localSymbol2.getNamespaceURI();
          if (str3 == str4)
          {
            Object localObject5 = this.workStack[(-1 + this.nesting)];
            if ((localObject5 instanceof MappingInfo)) {
              localObject5 = ((MappingInfo)localObject5).qname;
            }
            error('e', duplicateAttributeMessage(localSymbol2, localObject5));
          }
        }
        label845:
        label989:
        ...
        do
        {
          ...
          m = 0;
          break;
          if ((localMappingInfo2.tagHash == n) && (localMappingInfo2.local == str2) && (localMappingInfo2.prefix == str1)) {
          ...
          break label642;
          Symbol localSymbol3 = (Symbol)localObject1;
          str3 = localSymbol3.getNamespaceURI();
          str2 = localSymbol3.getLocalName();
      ...
      if (this.out == this.tlist) {
        if (j == 0)
        {
          ...
          i5 = localMappingInfo2.index;
          if ((i5 <= 0) || (this.tlist.objects[i5] != localObject3))
          {
            i5 = this.tlist.find(localObject3);
            localMappingInfo2.index = i5;
          }
          if (j != 0) {
            break label1179;
          }
          this.tlist.setElementName(this.tlist.gapEnd, i5);
        }
      }
      label1179:
      Object localObject2;
      ...
      do
      {
        for (;;)
        {
          ...
          break label1097;
          if ((m == 0) || (this.namespacePrefixes)) {
            this.tlist.setAttributeName(this.startIndexes[(j - 1)], i5);
          }
        }
        if (localMappingInfo2 == null) {
      ...
      } while ((m != 0) && (!this.namespacePrefixes));
      this.out.startAttribute(localObject2);
      int i3 = this.startIndexes[(j - 1)];
      if (j < this.attrCount) {}
      for (int i4 = this.startIndexes[j];; i4 = this.tlist.gapStart)
      {
        this.tlist.consumeIRange(i3 + 5, i4 - 1, this.out);
    ...
    for (int k = 1; k <= this.attrCount; k++) {
      this.workStack[(-1 + (k + this.nesting))] = null;
    }
    if (this.out != this.tlist)
    {
      this.base = this.out;
  ...
  public void emitEndElement(char[] paramArrayOfChar, int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      if (paramArrayOfChar != null)
      {
        ...
        Object localObject = this.workStack[(-1 + this.nesting)];
  ...
  public void emitStartAttribute(char[] paramArrayOfChar, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      this.workStack[(-1 + (this.nesting + this.attrCount))] = localMappingInfo;
  ...
  public void emitStartElement(char[] paramArrayOfChar, int paramInt1, int paramInt2)
  {
    ...
    MappingInfo localMappingInfo = lookupTag(paramArrayOfChar, paramInt1, paramInt2);
    startElementCommon();
    ensureSpaceInWorkStack(-1 + this.nesting);
    this.workStack[(-1 + this.nesting)] = localMappingInfo;
  }
  ...
  public void endAttribute()
  {
    ...
    int j = this.startIndexes[(-1 + this.attrCount)];
    int k = j;
    ...
    label481:
    for (String str = null;; str = this.currentNamespacePrefix)
    {
  ...
  public void startAttribute(Object paramObject)
  {
    ...
    this.workStack[(-1 + (this.nesting + this.attrCount))] = paramObject;
    if (this.nesting == 0)
    {
  ...
  public void startElement(Object paramObject)
  {
    ...
    {
      ensureSpaceInWorkStack(-1 + this.nesting);
      this.workStack[(-1 + this.nesting)] = paramObject;
    ...
    if (i == this.nesting)
    {
      ...
      label105:
      if (localNamespaceBinding2 != null) {
        break label172;
      }
      if (!(paramObject instanceof XName)) {
        break label164;
    ...
    label164:
    for (NamespaceBinding localNamespaceBinding4 = ((XName)paramObject).getNamespaceNodes();; localNamespaceBinding4 = NamespaceBinding.predefinedXML)
    {
