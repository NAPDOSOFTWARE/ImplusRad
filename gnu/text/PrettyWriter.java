  ...
  extends Writer
{
  ...
  public void endLogicalBlock()
  {
    ...
    if (this.currentBlock < 0)
    {
      ...
      int i3 = this.blocks[(-5 + (-6 + this.blockDepth))];
      if (i2 > i3) {
  ...
  int fitsOnLine(int paramInt, boolean paramBoolean)
  {
    ...
    if (paramInt >= 0) {
      if (posnColumn(this.queueInts[(paramInt + 1)]) <= j) {
        i = 1;
      }
    }
    while ((paramBoolean) || (indexColumn(this.bufferFillPointer) > j)) {
      return i;
    }
    return 0;
  }
        ...
        while (bool2)
        {
          ...
          else
          {
            ...
            for (;;)
            {
              ...
              break;
              i8 = i7 + i;
              if (i8 >= this.queueInts.length) {
                i8 -= this.queueInts.length;
              }
            }
            label296:
            if ((i6 >= 0) && (!paramBoolean2)) {
              return bool1;
            }
            bool2 = true;
          }
    ...
    throws IOException
  {
    ...
    label309:
    label345:
    for (int i2 = getPerLinePrefixEnd();; i2 = getPrefixLength())
    {
      int i3 = j - i2;
      int i4 = i1 - i3;
  ...
  void reallyEndLogicalBlock()
  {
    ...
    this.blockDepth = (-6 + this.blockDepth);
  ...
  public void startLogicalBlock(String paramString1, boolean paramBoolean, String paramString2)
  {
    ...
    label94:
    label109:
    for (this.miserWidth = -1;; this.miserWidth = Integer.parseInt(localObject2.toString()))
    {
      indentLoc.get(null);
      if (paramString1 != null) {
        write(paramString1);
