  ...
  implements Inlineable
{
  ...
  public static Expression validateApplyAdd(AddOp paramAddOp, ApplyExp paramApplyExp, InlineCalls paramInlineCalls)
  {
    ...
    if ((arrayOfExpression.length == 1) && (paramAddOp.plusOrMinus < 0))
    {
      ...
      {
        i = localType.getSignature().charAt(0);
        j = 0;
        localObject = null;
        if (i != 86)
        {
    ...
    {
      if (localObject != null) {
        paramApplyExp = new ApplyExp(PrimProcedure.makeBuiltinUnary(j, (Type)localObject), arrayOfExpression);
      }
  ...
  public static Expression validateApplyArithOp(ApplyExp paramApplyExp, InlineCalls paramInlineCalls, Type paramType, Procedure paramProcedure)
  {
    ...
    if (arrayOfExpression.length > 2) {
      paramApplyExp = pairwise(paramProcedure, paramApplyExp.getFunction(), arrayOfExpression, paramInlineCalls);
    }
    int m;
    label280:
    label346:
    do
    {
      ...
      for (;;)
      {
        ...
        case 2: 
          ...
          if ((n == 1) && (appropriateIntConstant(arrayOfExpression, 0, paramInlineCalls)))
          {
            k = 1;
          }
  ...
  public static Expression validateApplyNot(ApplyExp paramApplyExp, int paramInt, InlineCalls paramInlineCalls)
  {
    if (paramApplyExp.getArgCount() == 1)
    {
      ...
      paramApplyExp = paramInlineCalls.visitApplyOnly(new ApplyExp(BitwiseOp.xor, arrayOfExpression), null);
    }
    for (;;)
    {
      return paramApplyExp;
  ...
  public void compile(ApplyExp paramApplyExp, Compilation paramCompilation, Target paramTarget)
  {
    ...
    if (((n == 1) || (n == 2)) && (m >= 1) && (m <= 4))
    {
      ...
      if (n == 1)
      {
        ...
        label286:
        Target localTarget2 = StackTarget.getInstance((Type)localObject);
    ...
    for (;;)
    {
      ...
      break;
      label440:
      if (((localDivideOp.op == 5) && (m <= 10) && (m != 7)) || ((localDivideOp.op == 4) && (m == 10)))
      {
        m = 8;
        break label217;
      }
      ...
      return;
      label573:
      localLangObjType = Arithmetic.typeRealNum;
      break label271;
      label581:
      localObject = Arithmetic.typeIntNum;
      localMethod = Arithmetic.typeRatNum.getDeclaredMethod("make", 2);
      break label286;
      label601:
      if ((m != 4) || ((this.op != 1) && (this.op != 3) && (this.op != 2) && (this.op != 13) && (this.op != 14) && (this.op != 15) && (this.op != 7) && (this.op != 8) && ((this.op < 9) || (this.op > 11)))) {
        break label715;
      }
      compileIntNum(arrayOfExpression[0], arrayOfExpression[1], j, k, paramCompilation);
    }
    label715:
    if ((m == 1) || (m == 2) || (((m == 7) || (m == 8)) && ((this.op <= 8) || (this.op >= 13))))
    {
  ...
  public boolean compileIntNum(Expression paramExpression1, Expression paramExpression2, int paramInt1, int paramInt2, Compilation paramCompilation)
  {
    ...
    for (;;)
    {
      ...
      label631:
      int m = localDivideOp.rounding_mode;
      arrayOfType = null;
      if (m != 3)
      {
