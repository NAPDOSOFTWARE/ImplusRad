...
public class Arithmetic
{
  ...
  {
    if ((paramNumber instanceof Numeric)) {
      paramNumber = ((Numeric)paramNumber).toExact();
    }
    while ((!(paramNumber instanceof Double)) && (!(paramNumber instanceof Float)) && (!(paramNumber instanceof BigDecimal))) {
      return paramNumber;
    }
  ...
  {
    if ((paramNumber instanceof Numeric)) {
      paramNumber = ((Numeric)paramNumber).toInexact();
    }
    while (((paramNumber instanceof Double)) || ((paramNumber instanceof Float)) || ((paramNumber instanceof BigDecimal))) {
      return paramNumber;
    }
