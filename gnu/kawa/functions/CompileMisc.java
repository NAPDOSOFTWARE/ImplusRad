  ...
  implements Inlineable
{
  ...
  public static void compileCallCC(ApplyExp paramApplyExp, Compilation paramCompilation, Target paramTarget, Procedure paramProcedure)
  {
    ...
    if (((paramTarget instanceof IgnoreTarget)) || ((paramTarget instanceof ConsumerTarget)))
    {
      ...
      ReferenceExp localReferenceExp = new ReferenceExp(localDeclaration2);
      arrayOfExpression[0] = localReferenceExp;
  ...
  public static Expression validateApplyAppendValues(ApplyExp paramApplyExp, InlineCalls paramInlineCalls, Type paramType, Procedure paramProcedure)
  {
    ...
    do
    {
      ...
      localExpression = paramApplyExp.inlineIfConstant(paramProcedure, paramInlineCalls);
    } while (localExpression != paramApplyExp);
  ...
  {
    paramApplyExp.visitArgs(paramInlineCalls);
    Object localObject1 = Type.objectType;
    Object localObject2 = paramApplyExp.getArgs();
    if (localObject2.length > 0)
    {
      ClassType localClassType = ClassType.make("gnu.kawa.functions.Format");
      Object localObject3 = localObject2[0].valueIfConstant();
      Type localType = localObject2[0].getType();
      if ((localObject3 == Boolean.FALSE) || (localType.isSubtype(LangObjType.stringType)))
      {
        if (localObject3 == Boolean.FALSE) {}
        for (int i = 1;; i = 0)
        {
          Expression[] arrayOfExpression1 = new Expression[1 + localObject2.length - i];
          arrayOfExpression1[0] = new QuoteExp(Integer.valueOf(0), Type.intType);
          System.arraycopy(localObject2, i, arrayOfExpression1, 1, -1 + arrayOfExpression1.length);
          ApplyExp localApplyExp1 = new ApplyExp(localClassType.getDeclaredMethod("formatToString", 2), arrayOfExpression1);
      ...
      if ((localObject3 == Boolean.TRUE) || (localType.isSubtype(ClassType.make("java.io.Writer"))))
      {
        ...
        {
          Expression[] arrayOfExpression2 = new Expression[localObject2.length];
          arrayOfExpression2[0] = QuoteExp.nullExp;
          System.arraycopy(localObject2, 1, arrayOfExpression2, 1, -1 + localObject2.length);
          localObject2 = arrayOfExpression2;
        }
        ApplyExp localApplyExp2 = new ApplyExp(localClassType.getDeclaredMethod("formatToWriter", 3), (Expression[])localObject2);
    ...
    paramApplyExp.setType((Type)localObject1);
    return null;
  }
  ...
  public static Expression validateApplyMap(ApplyExp paramApplyExp, InlineCalls paramInlineCalls, Type paramType, Procedure paramProcedure)
  {
    ...
    int j = i - 1;
    Object localObject1 = arrayOfExpression1[0];
    int k;
    LetExp localLetExp1;
    Declaration localDeclaration1;
    Expression[] arrayOfExpression3;
    LetExp localLetExp2;
    if (!((Expression)localObject1).side_effects())
    {
      k = 1;
      Expression[] arrayOfExpression2 = { localObject1 };
    ...
    for (int m = j + 1;; m = j)
    {
      ...
      for (int n = 0; n < j; n++)
      {
        ...
        arrayOfExpression4[n] = new ReferenceExp(arrayOfDeclaration1[n]);
    ...
    Expression localExpression1 = paramInlineCalls.visitApplyOnly(localApplyExp1, null);
    if (bool)
    {
      Expression[] arrayOfExpression10 = new Expression[2];
      arrayOfExpression10[0] = localExpression1;
      ReferenceExp localReferenceExp3 = new ReferenceExp(localDeclaration3);
      arrayOfExpression10[1] = localReferenceExp3;
    ...
    ApplyExp localApplyExp2 = new ApplyExp(localReferenceExp1, arrayOfExpression6);
    Object localObject2 = paramInlineCalls.visitApplyOnly(localApplyExp2, null);
    int i3;
    label620:
    Expression[] arrayOfExpression7;
    ...
    if (bool)
    {
      ...
      arrayOfExpression9[0] = new ReferenceExp(arrayOfDeclaration1[i4]);
    ...
    label784:
    label791:
    for (Object localObject4 = new ReferenceExp(localDeclaration3);; localObject4 = QuoteExp.voidExp)
    {
      ApplyExp localApplyExp4 = new ApplyExp(localMap.isEq, arrayOfExpression9);
      Expression localExpression2 = paramInlineCalls.visitApplyOnly(localApplyExp4, null);
      Expression localExpression3 = localLambdaExp.body;
      IfExp localIfExp = new IfExp(localExpression2, (Expression)localObject4, localExpression3);
      localLambdaExp.body = localIfExp;
      arrayOfExpression7[i4] = arrayOfExpression1[(i4 + 1)];
      break label643;
      BeginExp localBeginExp = new BeginExp(localExpression1, (Expression)localObject2);
    ...
    ApplyExp localApplyExp3 = new ApplyExp(localReferenceExp2, arrayOfExpression7);
