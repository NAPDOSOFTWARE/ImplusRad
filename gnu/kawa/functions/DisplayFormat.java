  ...
  extends AbstractFormat
{
  ...
  int write(gnu.lists.Array paramArray, int paramInt1, int paramInt2, Consumer paramConsumer)
  {
    ...
    label182:
    label193:
    for (int i1 = 1;; i1 = write(paramArray, paramInt1, m, paramConsumer))
    {
      paramInt1 += i1;
      j += i1;
      n++;
  ...
  public void writeObjectRaw(Object paramObject, Consumer paramConsumer)
  {
    ...
    if ((paramObject instanceof SimpleVector))
    {
      ...
      for (int i1 = 0;; i1 += 2) {
        ...
        else
        {
          ...
          label486:
          write(str4, paramConsumer);
          break label374;
        }
      }
      label502:
      write(str5, paramConsumer);
      return;
    }
    ...
    if ((paramObject instanceof KNode))
    {
      ...
      for (Object localObject3 = (Writer)paramConsumer;; localObject3 = new ConsumerWriter(paramConsumer))
      {
