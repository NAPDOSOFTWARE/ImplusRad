  ...
  extends ModuleBody
{
  ...
  public Object apply1(ModuleMethod paramModuleMethod, Object paramObject)
  {
    ...
    try
    {
      KElement localKElement = (KElement)paramObject;
      return elementName(localKElement);
    }
    catch (ClassCastException localClassCastException2)
    {
      try
      {
        KAttr localKAttr = (KAttr)paramObject;
        return attributeName(localKAttr);
      }
      catch (ClassCastException localClassCastException1)
      {
        throw new WrongType(localClassCastException1, "attribute-name", 1, paramObject);
      }
      localClassCastException2 = localClassCastException2;
      throw new WrongType(localClassCastException2, "element-name", 1, paramObject);
    }
  }
