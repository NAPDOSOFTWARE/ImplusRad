  ...
  implements Node, Consumable
{
  ...
  public static Object atomicValue(Object paramObject)
  {
    if ((paramObject instanceof KNode))
    {
      ...
      paramObject = ((NodeTree)localKNode.sequence).typedValue(localKNode.ipos);
    }
    return paramObject;
  }
  ...
  public Node getPreviousSibling()
  {
    ...
    label84:
    return make((NodeTree)this.sequence, m);
  }
  ...
  public boolean isSameNode(Node paramNode)
  {
    ...
    {
      return false;
      localKNode = (KNode)paramNode;
    } while (this.sequence != localKNode.sequence);
