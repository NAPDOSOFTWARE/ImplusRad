  ...
  public Expression rewriteForm(Pair paramPair, Translator paramTranslator)
  {
    ...
    if ((localObject1 instanceof Pair))
    {
      ...
      for (;;)
      {
        ...
        break;
        label224:
        localObject9 = paramTranslator.rewrite_car(localPair4, false).valueIfConstant();
        break label177;
        label239:
        localStringBuilder.append(localObject9);
      }
      label250:
      String str3 = localStringBuilder.toString().intern();
      String str4;
      label270:
      ...
      for (;;)
      {
        ...
        break label270;
        label364:
        localObject7 = XmlNamespace.getInstance(str2, str3);
      }
    }
    ...
    try
    {
      ...
      Object localObject5 = paramTranslator.rewrite(Translator.makePair(paramPair, localMakeElement, localObject2));
      if (i != 0)
      {
        LetExp localLetExp = paramTranslator.letDone((Expression)localObject5);
        localObject5 = localLetExp;
      }
      return localObject5;
    }
    finally
