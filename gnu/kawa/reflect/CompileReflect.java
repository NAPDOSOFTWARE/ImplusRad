...
public class CompileReflect
{
  ...
  public static ApplyExp inlineClassName(ApplyExp paramApplyExp, int paramInt, InlineCalls paramInlineCalls)
  {
    ...
    {
      localType = localLanguage.getTypeFor(arrayOfExpression1[paramInt]);
  ...
  public static Expression validateApplySlotGet(ApplyExp paramApplyExp, InlineCalls paramInlineCalls, Type paramType, Procedure paramProcedure)
  {
    ...
    if (((localObject instanceof String)) || ((localObject instanceof FString)) || ((localObject instanceof Symbol)))
    {
      ...
      k = checkKnownClass(localType, localCompilation);
      if (k >= 0) {}
    }
    else
    {
    ...
    {
      if (k > 0) {
        return QuoteExp.getInstance(localType.getReflectClass());
      }
    ...
    if (localType != null)
    {
      ...
      QuoteExp localQuoteExp3 = new QuoteExp(localType);
      arrayOfExpression4[0] = localQuoteExp3;
    ...
    label395:
    if ((localClassType1 != null) && (!localClassType1.isAccessible(localField, localObjectType)))
    {
    ...
    if ((localType != localClassType2) && (localCompilation.warnUnknownMember())) {
