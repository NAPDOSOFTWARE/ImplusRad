  ...
  extends Location
{
    ...
    throws IllegalAccessException
  {
    ...
    for (;;)
    {
      ...
      break;
      label136:
      localObject2 = Compilation.demangleName(paramField.getName(), true);
      break label82;
      label149:
      if (paramString == null) {
        paramString = "";
      }
      String str = localObject2.toString().intern();
      localSymbol = Symbol.make(paramString, str);
      break label97;
      label177:
      localObject3 = null;
      if (j != 0) {
        localObject3 = paramLanguage.getEnvPropertyFor(paramField, localObject1);
      }
      if ((i & 0x8) != 0) {}
      for (int k = 1;; k = 0)
      {
      ...
      label229:
      localObject4 = new FieldLocation(paramObject, paramField);
    }
  }
  ...
  void setup()
  {
    ...
    //   0	130	0	this	ClassMemberLocation
    //   30	34	1	localRuntimeException	java.lang.RuntimeException
    //   61	8	2	localUnboundLocationException1	gnu.mapping.UnboundLocationException
    //   14	4	4	localClass	Class
    //   70	52	5	localNoSuchFieldException	java.lang.NoSuchFieldException
    //   117	11	6	localUnboundLocationException2	gnu.mapping.UnboundLocationException
    // Exception table:
    //   from	to	target	type
