  ...
  extends Syntax
{
  ...
  public Expression rewrite(Object paramObject, Translator paramTranslator)
  {
    ...
    if (!(paramObject instanceof Pair)) {
      localObject = paramTranslator.syntaxError("missing formals in lambda");
    }
    int i;
    do
    {
      ...
      localObject = new LambdaExp();
      Pair localPair = (Pair)paramObject;
      Translator.setLine((Expression)localObject, localPair);
      rewrite((LambdaExp)localObject, localPair.getCar(), localPair.getCdr(), paramTranslator, null);
  ...
  public Object rewriteAttrs(LambdaExp paramLambdaExp, Object paramObject, Translator paramTranslator)
  {
    ...
    for (;;)
    {
      ...
      continue;
      if (localObject3 == object.accessKeyword)
      {
      ...
      else if (localObject3 == object.allocationKeyword)
      {
      ...
      else if (localObject3 == object.throwsKeyword)
      {
      ...
      else if (localObject3 == nameKeyword)
      {
  ...
  public void rewriteBody(LambdaExp paramLambdaExp, Object paramObject, Translator paramTranslator)
  {
    ...
    label262:
    for (int k = 0;; k = paramLambdaExp.defaultArgs.length - j)
    {
      int m = 0;
      int n = 0;
      for (Object localObject2 = paramLambdaExp.firstDecl(); localObject2 != null; localObject2 = ((Declaration)localObject2).nextDecl())
      {
        ...
        if ((localExpression3 instanceof LangExp)) {
          ((Declaration)localObject2).setType(paramTranslator.exp2Type((Pair)((LangExp)localExpression3).getLangValue()));
        }
        localObject1 = localObject2;
        if ((m >= paramLambdaExp.min_args) && ((m < k + paramLambdaExp.min_args) || (paramLambdaExp.max_args >= 0) || (m != k + paramLambdaExp.min_args)))
        {
    ...
    Type localType = paramLambdaExp.returnType;
    if ((paramLambdaExp.body instanceof LangExp))
    {
      ...
      localType = paramTranslator.getLanguage().getTypeFor(localExpression2);
    }
    ...
    for (;;)
    {
      ...
      break;
      paramLambdaExp.setCoercedReturnType(localType);
    }
  }
  ...
  public void rewriteFormals(LambdaExp paramLambdaExp, Object paramObject, Translator paramTranslator, TemplateScope paramTemplateScope)
  {
    ...
    label958:
    Object localObject13 = paramTranslator.pushPositionOf(localObject8);
    ...
    if ((localObject15 instanceof Symbol))
    {
      ...
      boolean bool5 = ((Pair)localObject8).getCdr() instanceof Pair;
      localObject17 = null;
      if (bool5)
      {
        Pair localPair5 = (Pair)((Pair)localObject8).getCdr();
        boolean bool6 = paramTranslator.matches(localPair5.getCar(), "::");
        localObject17 = null;
        if (bool6)
        {
    ...
    while (localObject16 == null)
    {
      ...
      if (bool1)
      {
        ...
        Object localObject18 = localPair2.getCar();
        if ((localObject18 instanceof SyntaxForm))
        {
          SyntaxForm localSyntaxForm1 = (SyntaxForm)localObject18;
          localObject18 = localSyntaxForm1.getDatum();
          localTemplateScope = localSyntaxForm1.getScope();
        }
        Object localObject19 = paramTranslator.namespaceResolve(localObject18);
        boolean bool2 = localObject19 instanceof Symbol;
        localObject16 = null;
        localObject17 = null;
        if (bool2)
        {
    ...
    if ((localObject7 == this.optionalKeyword) || (localObject7 == this.keyKeyword))
    {
      Expression[] arrayOfExpression = paramLambdaExp.defaultArgs;
      int i1 = m + 1;
      LangExp localLangExp1 = new LangExp(localObject14);
    ...
    if (localObject7 == this.keyKeyword)
    {
    ...
    else
    {
      ...
      LangExp localLangExp2 = new LangExp(localObject17);
    ...
    for (;;)
    {
      ...
      break label1713;
      label1818:
      if (localObject7 == this.restKeyword) {
