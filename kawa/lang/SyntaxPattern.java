  ...
  implements Externalizable
{
  ...
  public static boolean literalIdentifierEq(Object paramObject1, ScopeExp paramScopeExp1, Object paramObject2, ScopeExp paramScopeExp2)
  {
    ...
    {
      boolean bool2 = paramScopeExp1 instanceof ModuleExp;
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        return false;
        label106:
        paramScopeExp1 = paramScopeExp1.outer;
        break label38;
      }
  ...
  void translate(Object paramObject, StringBuffer paramStringBuffer, Object[] paramArrayOfObject, int paramInt, Vector paramVector, SyntaxForm paramSyntaxForm, char paramChar, Translator paramTranslator)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        Object localObject7 = localPair.getCar();
        int i9;
        int i10;
        int i14;
        if (i7 != 0)
        {
          ...
          int i11 = -1 + (paramStringBuffer.length() - i6) << 3;
          if (i7 != 0)
          {
            i12 = 5;
            int i13 = i11 | i12;
      ...
      if (paramChar == 'P')
      {
        ...
        Declaration localDeclaration = localPatternScope.addDeclaration(paramObject);
      ...
      for (int i4 = 7;; i4 = 3)
      {
        addInt(paramStringBuffer, i4 | i3);
        return;
        m = 0;
        break;
        i1 = 0;
      ...
      int i = SyntaxTemplate.indexOf(paramVector, paramObject);
      if (i < 0)
      {
        i = paramVector.size();
        paramVector.addElement(paramObject);
