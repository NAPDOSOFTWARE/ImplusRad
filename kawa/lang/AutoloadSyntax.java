  ...
  implements Externalizable
{
  ...
  public gnu.expr.Expression rewriteForm(Pair paramPair, Translator paramTranslator)
  {
    ...
    //   0	77	0	this	AutoloadSyntax
    //   0	77	1	paramPair	Pair
    //   0	77	2	paramTranslator	Translator
    //   15	56	3	localSyntax	Syntax
    //   67	8	4	localObject	Object
    //   33	8	5	localExpression	gnu.expr.Expression
    //   55	4	6	localWrongType	gnu.mapping.WrongType
    //   43	4	7	localGenericError	GenericError
    // Exception table:
    //   from	to	target	type
