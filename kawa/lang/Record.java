...
public class Record
{
  ...
  public static ClassType makeRecordType(String paramString, LList paramLList)
  {
    ...
    CodeAttr localCodeAttr1 = localMethod1.startCode();
    localCodeAttr1.emitPushThis();
    localCodeAttr1.emitInvokeSpecial(localMethod2);
    localCodeAttr1.emitReturn();
    if (!paramString.equals(str1))
    {
      CodeAttr localCodeAttr2 = localClassType2.addMethod("getTypeName", Type.typeArray0, Compilation.typeString, 1).startCode();
      localCodeAttr2.emitPushString(paramString);
      localCodeAttr2.emitReturn();
    }
    for (;;)
    {
      LList localLList = LList.Empty;
      if (paramLList == localLList) {
        break;
      }
