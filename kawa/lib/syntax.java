  ...
  extends ModuleBody
{
  ...
  static
  {
    ...
    arrayOfObject2[4] = PairWithPosition.make(Lit102, Pair.make(Lit103, Pair.make(Pair.make(Lit104, Pair.make((SimpleSymbol)new SimpleSymbol("makeNamed").readResolve(), LList.Empty)), LList.Empty)), "syntax.scm", 1069060);
    arrayOfObject2[5] = Lit108;
    arrayOfObject2[6] = PairWithPosition.make(Lit102, Pair.make(Lit103, Pair.make(Pair.make(Lit104, Pair.make((SimpleSymbol)new SimpleSymbol("pushConverter").readResolve(), LList.Empty)), LList.Empty)), "syntax.scm", 1073161);
    ...
    arrayOfObject2[16] = PairWithPosition.make(Lit102, Pair.make((SimpleSymbol)new SimpleSymbol("gnu.mapping.WrongType").readResolve(), Pair.make(Pair.make(Lit104, Pair.make((SimpleSymbol)new SimpleSymbol("make").readResolve(), LList.Empty)), LList.Empty)), "syntax.scm", 1097748);
    ...
    SimpleSymbol localSimpleSymbol2 = (SimpleSymbol)new SimpleSymbol("receive").readResolve();
    Lit98 = localSimpleSymbol2;
    ...
    SimpleSymbol localSimpleSymbol3 = (SimpleSymbol)new SimpleSymbol("cond-expand").readResolve();
    Lit91 = localSimpleSymbol3;
    ...
    SimpleSymbol localSimpleSymbol4 = (SimpleSymbol)new SimpleSymbol("let*-values").readResolve();
    Lit79 = localSimpleSymbol4;
    arrayOfObject24[0] = localSimpleSymbol4;
    ...
    SimpleSymbol localSimpleSymbol5 = (SimpleSymbol)new SimpleSymbol("let-values").readResolve();
    Lit77 = localSimpleSymbol5;
    arrayOfObject26[0] = localSimpleSymbol5;
    ...
    SimpleSymbol localSimpleSymbol6 = (SimpleSymbol)new SimpleSymbol("%import").readResolve();
    Lit38 = localSimpleSymbol6;
    ...
    SimpleSymbol localSimpleSymbol7 = (SimpleSymbol)new SimpleSymbol("jdField_import").readResolve();
    Lit36 = localSimpleSymbol7;
    arrayOfObject47[0] = localSimpleSymbol7;
    ...
    SimpleSymbol localSimpleSymbol8 = (SimpleSymbol)new SimpleSymbol("when").readResolve();
    Lit17 = localSimpleSymbol8;
    arrayOfObject49[0] = localSimpleSymbol8;
    ...
    SimpleSymbol localSimpleSymbol9 = (SimpleSymbol)new SimpleSymbol("define-syntax-case").readResolve();
    Lit15 = localSimpleSymbol9;
    arrayOfObject53[0] = localSimpleSymbol9;
    ...
    SimpleSymbol localSimpleSymbol10 = (SimpleSymbol)new SimpleSymbol("define-macro").readResolve();
    Lit13 = localSimpleSymbol10;
    arrayOfObject55[0] = localSimpleSymbol10;
    ...
    SimpleSymbol localSimpleSymbol11 = (SimpleSymbol)new SimpleSymbol("defmacro").readResolve();
    Lit11 = localSimpleSymbol11;
    arrayOfObject58[0] = localSimpleSymbol11;
    ...
    SimpleSymbol localSimpleSymbol12 = Lit21;
    syntax localsyntax = $instance;
    try$Mnfinally = Macro.make(localSimpleSymbol12, new ModuleMethod(localsyntax, 2, null, 4097), $instance);
    ...
    SimpleSymbol localSimpleSymbol13 = Lit93;
    ...
    $Pccond$Mnexpand = Macro.make(localSimpleSymbol13, localModuleMethod, $instance);
  ...
  public static boolean isIdentifierList(Object paramObject)
  {
    ...
    while (bool)
    {
      for (;;)
      {
        ...
        bool = std_syntax.isIdentifier(Lit1.execute(arrayOfObject, localTemplateScope1));
        if (!bool) {
          break label88;
        }
  ...
  public static boolean isIdentifierPairList(Object paramObject)
  {
    ...
    while (bool)
    {
      for (;;)
      {
        ...
        TemplateScope localTemplateScope1 = TemplateScope.make();
        bool = std_syntax.isIdentifier(Lit6.execute(arrayOfObject, localTemplateScope1));
        if (!bool) {
          break label110;
        }
        TemplateScope localTemplateScope2 = TemplateScope.make();
        bool = std_syntax.isIdentifier(Lit7.execute(arrayOfObject, localTemplateScope2));
        if (!bool) {
          break label110;
        }
    ...
    extends ModuleBody
  {
    ...
    Object lambda1(Object paramObject)
    {
      ...
      label33:
      Object localObject2;
      for (Object localObject1 = this.list;; localObject1 = localObject2)
      {
        int i;
        if (paramObject == null)
        {
        ...
        paramObject = Scheme.applyToArgs.apply3(lists.caar.apply1(localObject1), paramObject, lists.cdar.apply1(localObject1));
      }
    }
