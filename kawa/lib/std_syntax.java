  ...
  extends ModuleBody
{
  ...
  public static boolean isFreeIdentifier$Eq(Object paramObject1, Object paramObject2)
  {
    ...
    //   0	50	0	paramObject1	Object
    //   0	50	1	paramObject2	Object
    //   18	6	2	localClassCastException1	ClassCastException
    //   4	8	3	localSyntaxForm1	SyntaxForm
    //   33	7	4	localClassCastException2	ClassCastException
    //   9	4	5	localSyntaxForm2	SyntaxForm
    // Exception table:
    //   from	to	target	type
  ...
  {
    boolean bool = paramObject instanceof Symbol;
    if (bool) {}
    do
    {
      return bool;
      bool = paramObject instanceof SyntaxForm;
    } while (!bool);
    try
    {
  ...
  public static Object syntaxColumn(Object paramObject)
  {
    ...
    if ((paramObject instanceof PairWithPosition)) {
      return Integer.valueOf(0 + ((PairWithPosition)paramObject).getColumnNumber());
    }
  ...
  public static Object syntaxSource(Object paramObject)
  {
    Object localObject;
    if ((paramObject instanceof SyntaxForm)) {
      localObject = syntaxSource(((SyntaxForm)paramObject).getDatum());
    }
    do
    {
      return localObject;
      ...
      localObject = ((PairWithPosition)paramObject).getFileName();
