...
public class Shell
{
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      localObject1 = localCompiledModule;
  ...
  public static Consumer getOutputConsumer(OutPort paramOutPort)
  {
    ...
    try
    {
      Object[] arrayOfObject2 = new Object[-4 + arrayOfObject1.length];
      ...
      localObject = defaultFormatMethod.invoke(null, arrayOfObject2);
    }
    ...
    throws Throwable
  {
    ...
    try
    {
      ...
      localCompiledModule = checkCompiledZip(paramInputStream, paramPath, paramEnvironment, localLanguage);
      if (localCompiledModule != null) {
        break label219;
      }
      ...
      try
      {
        ...
        {
          localObject3 = getOutputConsumer(OutPort.outDefault());
          localThrowable = run(localLanguage, paramEnvironment, localInPort, (Consumer)localObject3, null, localURL, localSourceMessages);
          if (localThrowable == null) {
            break label214;
          }
    ...
    {
      Throwable localThrowable;
      Object localObject3 = new VoidConsumer();
    }
    label170:
    CompiledModule localCompiledModule = compileSource(localInPort, paramEnvironment, localURL, localLanguage, localSourceMessages);
    ...
    label219:
    if (localCompiledModule != null) {
      localCompiledModule.evalModule(paramEnvironment, OutPort.outDefault());
    }
    currentLoadPath.set(localPath);
    return true;
  }
  ...
  public static boolean runFileOrClass(String paramString, boolean paramBoolean, int paramInt)
  {
    ...
    //   92: invokevirtual 493	gnu/expr/CompiledModule:evalModule	(Lgnu/mapping/Environment;Lgnu/mapping/OutPort;)V
    //   95: iconst_1
    //   96: ireturn
    //   97: astore 5
    ...
    //   3	80	3	localLanguage	Language
    //   72	44	4	localThrowable1	Throwable
    //   97	1	5	localThrowable2	Throwable
    //   78	3	6	localClass	Class
    //   131	3	7	localThrowable3	Throwable
    //   20	31	8	localPath	Path
    //   25	31	9	localInputStream	InputStream
    //   60	3	10	localThrowable4	Throwable
    //   39	3	11	bool	boolean
    // Exception table:
    //   from	to	target	type
