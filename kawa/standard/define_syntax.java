  ...
  extends Syntax
{
  ...
  public void scanForm(Pair paramPair, ScopeExp paramScopeExp, Translator paramTranslator)
  {
    ...
    arrayOfExpression1[0] = new QuoteExp(localObject5);
    ...
    {
      ApplyExp localApplyExp = new ApplyExp(localPrimProcedure, arrayOfExpression1);
      localDeclaration.noteValue(localApplyExp);
      localDeclaration.setProcedureDecl(true);
      if (!(localDeclaration.context instanceof ModuleExp)) {
        break;
      }
      SetExp localSetExp = new SetExp(localDeclaration, localApplyExp);
      ...
      arrayOfExpression2[0] = new ReferenceExp(localDeclaration);
      arrayOfExpression2[1] = new QuoteExp(paramScopeExp);
      paramTranslator.formStack.addElement(new ApplyExp(setCapturedScope, arrayOfExpression2));
      return;
    }
  }
}
