  ...
  extends LispLanguage
{
  ...
  public static Type string2Type(String paramString)
  {
    ...
    {
      localObject = string2Type(paramString.substring(0, -2 + paramString.length()));
      if (localObject == null) {}
    }
  ...
  public Expression checkDefaultBinding(Symbol paramSymbol, Translator paramTranslator)
  {
    ...
    for (int m = 1;; m = 0)
    {
      ...
      for (int i8 = 0; i8 < i7; i8++)
      {
        ...
        if (localIntNum.longValue() != 1L)
        {
          ...
          ApplyExp localApplyExp2 = new ApplyExp(localexpt, arrayOfExpression3);
      ...
      for (Object localObject3 = arrayOfExpression1[0];; localObject3 = new ApplyExp(localMultiplyOp1, arrayOfExpression1))
      {
        ...
        ApplyExp localApplyExp1 = new ApplyExp(localMultiplyOp2, arrayOfExpression2);
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        localType = Type.lookupType(str3);
        ...
        localClass = ((Type)localObject2).getReflectClass();
        localQuoteExp = QuoteExp.getInstance(localClass);
