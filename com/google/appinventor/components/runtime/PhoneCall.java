  ...
  implements Component, OnDestroyListener
{
  ...
  public void PhoneCallEnded(int paramInt, String paramString)
  {
    ...
    EventDispatcher.dispatchEvent(this, "PhoneCallEnded", arrayOfObject);
  }
  ...
  public void PhoneCallStarted(int paramInt, String paramString)
  {
    ...
    arrayOfObject[0] = Integer.valueOf(paramInt);
    arrayOfObject[1] = paramString;
    EventDispatcher.dispatchEvent(this, "PhoneCallStarted", arrayOfObject);
  }
    ...
    extends BroadcastReceiver
  {
    ...
    public void onReceive(Context paramContext, Intent paramIntent)
    {
      ...
      if ("android.intent.action.PHONE_STATE".equals(str1))
      {
      ...
      while (!"android.intent.action.NEW_OUTGOING_CALL".equals(str1))
      {
        String str2;
        do
        {
          ...
          return;
        } while (!TelephonyManager.EXTRA_STATE_IDLE.equals(str2));
        if (this.status == 1) {
