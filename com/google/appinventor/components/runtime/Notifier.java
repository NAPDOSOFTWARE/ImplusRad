  ...
  implements Component
{
  ...
  public static void oneButtonAlert(Activity paramActivity, String paramString1, String paramString2, String paramString3)
  {
    ...
    localAlertDialog.setButton(-3, paramString3, new DialogInterface.OnClickListener()
    {
  ...
  private void textInputDialog(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    localAlertDialog.setButton(-1, "OK", new DialogInterface.OnClickListener()
    {
      public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt)
      {
        Notifier.this.HideKeyboard(localEditText);
