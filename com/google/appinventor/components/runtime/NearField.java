  ...
  implements OnStopListener, OnResumeListener, OnPauseListener, OnNewIntentListener, Deleteable
{
  ...
  public NearField(ComponentContainer paramComponentContainer)
  {
    ...
    for (NfcAdapter localNfcAdapter = GingerbreadUtil.newNfcAdapter(this.activity);; localNfcAdapter = null)
    {
      this.nfcAdapter = localNfcAdapter;
 ...
 * Qualified Name:     com.google.appinventor.components.runtime.NearField
