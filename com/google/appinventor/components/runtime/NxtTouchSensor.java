  ...
  implements Deleteable
{
  ...
  private final Runnable sensorReader = new Runnable()
  {
    public void run()
    {
      ...
      label154:
      for (NxtTouchSensor.State localState = NxtTouchSensor.State.PRESSED;; localState = NxtTouchSensor.State.RELEASED)
      {
  ...
  public boolean IsPressed()
  {
    ...
    {
      return false;
      localSensorValue = getPressedValue("IsPressed");
    } while (!localSensorValue.valid);
