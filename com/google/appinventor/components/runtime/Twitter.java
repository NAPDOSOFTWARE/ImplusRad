    ...
    AsynchUtil.runAsynchronously(new Runnable()
    {
      public void run()
      {
        ...
        catch (TwitterException localTwitterException)
        {
          ...
          Object[] arrayOfObject = new Object[1];
          arrayOfObject[0] = localTwitterException.getMessage();
          localForm.dispatchErrorOccurredEvent(localTwitter, "Tweet", 306, arrayOfObject);
        }
      }
    });
  }
      ...
      public void run()
      {
        try
        {
          ...
          if (str.startsWith("file://")) {
            str = paramString2.replace("file://", "");
          }
          File localFile = new File(str);
          if (localFile.exists())
          {
            StatusUpdate localStatusUpdate = new StatusUpdate(paramString1);
            localStatusUpdate.setMedia(localFile);
            Twitter.this.twitter.updateStatus(localStatusUpdate);
            return;
          }
        ...
        catch (TwitterException localTwitterException)
        {
          ...
          Object[] arrayOfObject = new Object[1];
          arrayOfObject[0] = localTwitterException.getMessage();
          localForm.dispatchErrorOccurredEvent(localTwitter, "TweetWithImage", 306, arrayOfObject);
        }
      }
    });
  }
