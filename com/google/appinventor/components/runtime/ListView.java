...
@DesignerComponent(category=ComponentCategory.USERINTERFACE, description="<p>This is a visible component that displays a list of text elements. <br> The list can be set using the ElementsFromString property or using the Elements block in the blocks editor. <br> Warning: This component will not work correctly on Screens that are scrollable.</p>", iconName="images/listView.png", nonVisible=false, version=4)
@SimpleObject
  ...
  implements AdapterView.OnItemClickListener
{
  ...
  public Spannable[] itemsToColoredText()
  {
    ...
    Spannable[] arrayOfSpannable = new Spannable[i];
    for (int j = 1; j <= i; j++)
    {
      SpannableString localSpannableString = new SpannableString(this.items.get(j).toString());
      ...
      arrayOfSpannable[(j - 1)] = localSpannableString;
    }
 ...
 * Qualified Name:     com.google.appinventor.components.runtime.ListView
