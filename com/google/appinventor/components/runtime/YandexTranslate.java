  ...
  extends AndroidNonvisibleComponent
{
    ...
    throws IOException
  {
    ...
    InputStreamReader localInputStreamReader = new InputStreamReader(paramHttpURLConnection.getInputStream(), str1);
  ...
  private void performRequest(String paramString1, String paramString2)
    throws IOException, JSONException
  {
    HttpURLConnection localHttpURLConnection = (HttpURLConnection)new URL("https://translate.yandex.net/api/v1.5/tr.json/translate?key=" + this.yandexKey + "&lang=" + paramString1 + "&text=" + URLEncoder.encode(paramString2, "UTF-8")).openConnection();
    if (localHttpURLConnection != null) {}
    try
    {
      JSONObject localJSONObject = new JSONObject(getResponseContent(localHttpURLConnection));
      final String str1 = localJSONObject.getString("code");
      final String str2 = (String)localJSONObject.getJSONArray("text").get(0);
      this.activity.runOnUiThread(new Runnable()
      {
        public void run()
        {
          YandexTranslate.this.GotTranslation(str1, str2);
        }
      });
      return;
    }
 ...
 * Qualified Name:     com.google.appinventor.components.runtime.YandexTranslate
