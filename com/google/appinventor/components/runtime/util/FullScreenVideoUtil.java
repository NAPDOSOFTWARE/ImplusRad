  ...
  public Bundle performAction(int paramInt, VideoPlayer paramVideoPlayer, Object paramObject)
  {
    for (;;)
    {
      try
      {
        ...
        ((Bundle)localObject2).putBoolean("ActionSuccess", true);
        ...
        {
        default: 
          ((Bundle)localObject2).putBoolean("ActionSuccess", false);
          return localObject2;
        }
      }
      finally {}
      Object localObject2 = doFullScreenVideoAction(paramVideoPlayer, (Bundle)paramObject);
      continue;
      if (showing())
      {
        this.mFullScreenVideoView.pause();
        ...
        else
        {
          ...
          else
          {
            ...
            else
            {
              ...
              if (showing())
              {
                ((Bundle)localObject2).putBoolean("ActionSuccess", setSource((String)paramObject, true));
              }
              else
              {
                ((Bundle)localObject2).putBoolean("ActionSuccess", false);
                ...
                if (showing())
                {
                  ((Bundle)localObject2).putInt("ActionData", this.mFullScreenVideoView.getDuration());
                }
                else
                {
                  ((Bundle)localObject2).putBoolean("ActionSuccess", false);
                  ...
                  if (paramInt == 195)
                  {
                    if ((showing()) && (this.mFullScreenPlayer != null))
                    {
                      ...
                      localBundle2.putInt("PositionKey", this.mFullScreenVideoView.getCurrentPosition());
                      localBundle2.putBoolean("PlayingKey", this.mFullScreenVideoView.isPlaying());
                      localBundle2.putString("SourceKey", this.mFullScreenVideoBundle.getString("SourceKey"));
                      this.mFullScreenPlayer.fullScreenKilled(localBundle2);
                    }
                    Bundle localBundle1 = doFullScreenVideoAction(paramVideoPlayer, (Bundle)paramObject);
