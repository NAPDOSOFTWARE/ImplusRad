    ...
    new AudioManager.OnAudioFocusChangeListener()
    {
      ...
      public void onAudioFocusChange(int paramAnonymousInt)
      {
        ...
        do
        {
          ...
          {
            return;
          } while ((this.val$player == null) || (this.val$player.playerState != 2));
          ...
          return;
        } while ((this.val$player == null) || (!this.playbackFlag) || (this.val$player.playerState != 4));
 ...
 * Qualified Name:     com.google.appinventor.components.runtime.util.FroyoUtil
