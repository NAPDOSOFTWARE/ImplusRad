    ...
    private boolean findDelimOrEnd(int paramInt)
    {
      for (;;)
      {
        ...
        case '\r': 
          ...
          this.delimitedCellLength = (i - this.pos);
          return true;
        case '\n': 
        case ',': 
    ...
    public ArrayList<String> next()
    {
      ...
      for (;;)
      {
        ...
        if (this.buf[this.pos] != '"')
        {
          ...
          if ((this.delimitedCellLength <= 0) || (this.buf[(-1 + (this.pos + this.delimitedCellLength))] != ',')) {
            break label196;
          }
          i = 1;
        ...
        for (int j = 1;; j = 0)
        {
          ...
          String str = new String(this.buf, 1 + this.pos, -2 + this.cellLength);
