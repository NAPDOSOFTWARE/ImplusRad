  ...
  extends AndroidViewComponent
{
  ...
  public Label(ComponentContainer paramComponentContainer)
  {
    ...
    {
      this.linearLayoutParams = ((LinearLayout.LayoutParams)localLayoutParams);
  ...
  {
    return Math.round(paramView.getContext().getResources().getDisplayMetrics().density * paramInt);
  }
