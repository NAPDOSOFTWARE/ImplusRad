...
public class EventDispatcher
{
  ...
  public static boolean dispatchEvent(Component paramComponent, String paramString, Object... paramVarArgs)
  {
    ...
    if (bool1)
    {
      ...
      if (localSet != null)
      {
        ...
        bool2 = false;
        if (i > 0) {
          bool2 = delegateDispatchEvent(localHandlesEventDispatching, localSet, paramComponent, paramVarArgs);
        }
      }
    }
    return bool2;
  ...
  private static final class EventClosure
  {
    ...
    {
      if (this == paramObject) {}
      EventClosure localEventClosure;
      do
      {
        return true;
        ...
        localEventClosure = (EventClosure)paramObject;
        if (!this.componentId.equals(localEventClosure.componentId)) {
          return false;
        }
      } while (this.eventName.equals(localEventClosure.eventName));
      return false;
    }
