  ...
  private void playWhenLoadComplete()
  {
    ...
    this.playWaitHandler.postDelayed(new Runnable()
    {
      public void run()
      {
        ...
        Form localForm = Sound.this.form;
        Component localComponent = Sound.this.thisComponent;
        Object[] arrayOfObject = new Object[1];
        arrayOfObject[0] = Sound.this.sourcePath;
        localForm.dispatchErrorOccurredEvent(localComponent, "Play", 710, arrayOfObject);
      }
    }, 50L);
  }
