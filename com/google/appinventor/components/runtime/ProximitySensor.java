  ...
  implements OnStopListener, OnResumeListener, SensorComponent, OnPauseListener, SensorEventListener, Deleteable
{
  ...
  public void ProximityChanged(float paramFloat)
  {
    ...
    arrayOfObject[0] = Float.valueOf(this.distance);
    EventDispatcher.dispatchEvent(this, "ProximityChanged", arrayOfObject);
  }
 ...
 * Qualified Name:     com.google.appinventor.components.runtime.ProximitySensor
